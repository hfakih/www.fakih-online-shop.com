...
<head>
	...
	<title>Fakih Online Shop\Login</title>
	...
	<link type="text/css" rel="stylesheet" href="css/login-page.css" media="screen" />
...
<body>
	...
	<div id="wrapper">
        ...
        <!--content begin-->
        <div id="content">
			<h2 class="title-page">Anmelden</h2>


			<div id="wrap-already-customer">
  <h2 class="h2-wrap-new-already-customer" >Ich bin bereits Kunde</h2>
  <form>
	  <div class="form-group form-group-form-already-customer">
		<label style="text-transform: uppercase;"><b>Email</b></label>
		<input name="email" class="form-control form-control-form-already-customer" required="" type="text">
	  </div>

	  <div class="form-group form-already-customer">
		<label style="text-transform: uppercase;"><b>Passwort</b></label>
		<input name="psw" class="form-control form-control-form-already-customer" required=""  type="password">
	  </div>

	  <span><a href="#" id="link-forgot-psw-already-customer">Passwort vergessen?</a></span>
	  <br><br>
				
	  <button id="login-btn-form-already-customer" class="btn btn-lg" type="submit">Einloggen</button>		  
  </form>
</div>

			<div id="wrap-new-customer" >
	<h2 class="h2-wrap-new-already-customer">Ich bin Neu</h2>
    <p id="txt-wrap-new-customer">Zur rascheren Bearbeitung Ihrer Bestellung jetzt unter Angabe von nur zwei Daten ein Konto einrichten! Dazu gibt's den Newsletter mit den heißesten Infos über Trends und Promos gratis.</p>
  
	<p id="wrap-register-link-wrap-new-customer"><a>Registrieren</a></p>
		...
		<div id="footer2"> 
			<div id="branch-search">
				...
				<h2 style="margin-bottom: 10px;">Finden Sie Ihre Filiale</h2>
				 <form action="login.php?#branch-search" class="form-inline">
				...
				<?php
					...
					<form action="login.php?" style="position: relative;">
...
<div class="form-group">
	...
	<script>
		...
		// register window begin
		$('#register-link-login-dropdown, #wrap-register-link-wrap-new-customer a').click(function(){
			$('#transparent-div').show();
			$('#register-win').show();
		});
