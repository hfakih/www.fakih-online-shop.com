...
<head>
	...
	<title>Fakih Online Shop/Frauen</title>
	...
	<link href="css/women-department.css" rel="stylesheet">
	...
	<div id="wrapper">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active" >
				<a href="women/wear/new.html">
					<img src="images/carousel-pic1.jpg" alt="Carousel Pic 1"><div style="width: 300px;height: 115px;position: absolute;/*! background: #fff; *//*! bottom: 55px; */left: 50%;/*! text-align: center; */margin-left: 150px;letter-spacing: 2px;line-height: 60px;font-weight: bold;top: 50%;margin-top: -58px;color: #000;">
					<span style="/*! text-align: center; */margin-bottom: 10px;background: #fff;padding-top: 10px;margin-top: 0px;padding-bottom: 10px;width: 194px;margin: 10px auto;font-size: 30px;">pretty young </span><br>
					<span style="background: #fff;padding-bottom: 10px;padding-top: 10px;font-size: 30px;/*! margin-top: 20px; *//*! margin-bottom: 10px; */">things</span>
					<br>
					<span style="text-decoration: underline;font-weight: 600;background: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">neuheiten shoppen</span></div>
				</a>
			</div>
			<div class="item">
				<a href="women/wear/jeans-guide.html">
					<img src="images/carousel-pic2.jpg" alt="Carousel Pic 2">
					<div style="width: 300px;height: 115px;position: absolute;/*! background: #fff; */bottom: 55px;left: 50%;text-align: center;margin-left: -150px;letter-spacing: 2px;/*! top: 0p; */color: #000;"><h2 style="text-align: center;margin-bottom: 0px;background: #fff;padding-top: 10px;margin-top: 10px;padding-bottom: 10px;width: 194px;margin: 10px auto;">Jeans Guide</h2><br><span style="text-decoration: underline;font-weight: 600;background: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">alles ansehen</span></div>
				</a>
			</div>
		</div>
		...
		<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
			...
			<div class="container" style="padding-right: 0px;padding-left: 0px;width: 1000px; margin-bottom: 60px">
		
		<div class="row" style="margin-left: 0px;margin-right: 0px;">
			<div class="col-md-4" style="padding-left: 0px;padding-right: 10px;width: 333.33px;">
			<a class="scard-link-women" data-cat="wear" href="women/wear/dress.php" style="position: relative; display:block;"><img src="images/dress.jpg">
			
			<span style="position: absolute;top: 50%;margin-top: -10px;left: 50%;margin-left: -44px;z-index: 10;background: #fff;color: #000;font-weight: bold;padding-top: 10px;padding-bottom: 10px;font-size: 26px;">Kleider</span>
			</a>
			</div>
			<div class="col-md-4" style="padding-left: 5px;width: 333.33px;padding-right: 5px;">
				<a href="women/wear/top.html" style="position: relative"><img src="images/top.jpg"></a>
				<span style="position: absolute;top: 50%;margin-top: -10px;left: 50%;margin-left: -23px;z-index: 10;background: #fff;color: #000;font-weight: bold;padding-top: 10px;padding-bottom: 10px;font-size: 26px;">Top</span>
			
			</div>
			<div class="col-md-4" style="width: 333.33px;padding-left: 10px;padding-right: 0px;">
				<a href="women/wear/jeans.html" style="position: relative; display:block;"><img src="images/jeans.jpg">
				
				<span style="position: absolute;top: 50%;margin-top: -10px;left: 50%;margin-left: -37px;z-index: 10;background: #fff;color: #000;font-weight: bold;padding-top: 10px;padding-bottom: 10px;font-size: 26px;">Jeans</span>
			...
			<div class="container" style="padding-right: 0px;padding-left: 0px;width: 1000px;margin-bottom: 60px;">
		<h2 style="text-align:center; letter-spacing:3px; font-weight: 600;">#fakihtrend</h2>
		<a href="women/trends/dress.html">
			<div style="position: relative;width: auto;height: 431px;">	
				<div style="height: 371px;width: auto;background: #F8F1E7;position: absolute;bottom: 0px;z-index: 5;left: 0px;width: 1000px;opacity: .5;"></div>
				<img src="images/trend.jpg" style="width: 742px;position: absolute;top: 0px;left: 60px;/*! bottom: 50px; */z-index: 10;">
					
					
				<span style="color: #000;background: #fff;padding-bottom: 10px;padding-top: 10px;position: absolute;z-index: 10;right: 120px;top: 200px;font-size: 26px;font-weight: 600;">Leder Röcke</span>
				
				<span style="color: #000;background: #fff;padding-bottom: 10px;padding-top: 10px;position: absolute;z-index: 10;right: 120px;top: 275px;font-size: 26px;font-weight: 600;padding-left: 2px;padding-right: 2px;text-decoration: underline;">kaufe</span>
		...
		<div id="footer2"> 
			<div id="branch-search">
				...
				<h2 style="margin-bottom: 10px;">Finden Sie Ihre Filiale</h2>
				 <form action="women.php?#branch-search" class="form-inline">
				...
				<?php
					...
					<form action="women.php?" style="position: relative;">
